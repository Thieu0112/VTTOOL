...
{trang}  ╚═══╝     ╚═╝      ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝
{trang}------------------------------------------------------------
{thanh} {vang}Tool Trao Đổi Sub Facebook - Version 1.0
{thanh} {luc}Chào mừng bạn đến với hệ thống VTTOOL
{thanh} {tim}ADMIN:VIẾT THIỆU
{thanh} {lam}MBBANK:0879968660
{trang}------------------------------------------------------------
''')
...
def Delay(value):
	while not(value <= 1):
		value -= 0.123
		print(f'''{trang}[{lam}VTHIEU{trang}] [{lam}DELAY{trang}] [{lam}{str(value)[0:5]}{trang}] [{vang}X    {trang}]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''{trang}[{lam}VTHIEU{trang}] [{lam}DELAY{trang}] [{lam}{str(value)[0:5]}{trang}] [ {vang}X   {trang}]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''{trang}[{lam}VTHIEU{trang}] [{lam}DELAY{trang}] [{lam}{str(value)[0:5]}{trang}] [  {vang}X  {trang}]''', '               ', end = '\r')
                            ...
                            for x in list_nv:
                                ...
                                if like == False:
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}{type}{red}][{lam}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]')
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                        if dem % nvblock == 0:
                            ...
                            for x in list_nv:
                                ...
                                if like == False:
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        dem+=1
                                        time = datetime.now().strftime("%H:%M:%S")
                                        print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}{type}CMT{red}][{lam}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]')
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                        if dem % nvblock == 0:
                        ...
                        for x in list_nv:
                            ...
                            if like == False:
                                ...
                                if 'success' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}SHARE{red}][{lam}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]')
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                                    if dem % nvblock == 0:
                        ...
                        if len(list_nv) == 0:
                            ...
                            for x in list_nv:
                                ...
                                if like == False:
                                    ...
                                    loifollow = 0
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}FOLLOW{red}][{lam}{id2}{red}][{trang}{cache}{luc}/{vang}5{red}]')
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                                    if dem % nvblock == 0:
                        ...
                        if len(list_nv) == 0:
                            ...
                            for x in list_nv:
                                ...
                                if like == False:
                                    ...
                                    loipage = 0
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}LIKEPAGE{red}][{lam}{id2}{red}][{trang}{cache}{luc}/{vang}5{red}]')
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                                    if dem % nvblock == 0:
                        ...
                        for x in list_nv:
                            ...
                            if like == False:
                                ...
                                if 'success' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}GROUP{red}][{lam}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]')
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                                    if dem % nvblock == 0:
                            ...
                            for x in list_nv:
                                ...
                                if like == False:
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        dem+=1
                                        time = datetime.now().strftime("%H:%M:%S")
                                        print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}LIKEPAGETHUONG{red}][{lam}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]')
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                        if dem % nvblock == 0:
                            ...
                            for x in list_nv:
                                ...
                                if like == False:
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        dem+=1
                                        time = datetime.now().strftime("%H:%M:%S")
                                        print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}LIKETHUONG{red}][{lam}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]')
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                        if dem % nvblock == 0:
                            ...
                            for x in list_nv:
                                ...
                                if like == False:
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        dem+=1
                                        time = datetime.now().strftime("%H:%M:%S")
                                        print(f'{red}[{trang}{dem}{red}][{lam}{time}{red}][{vang}{type}THUONG{red}][{lam}{id2}{red}][{luc}{msg}{red}][{vang}{str(format(int(xu),","))}{red}][{trang}{myip}{red}]')
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                        if dem % nvblock == 0:
